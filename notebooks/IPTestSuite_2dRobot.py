...
benchList.append(Benchmark(
    "Trap",
    CollisionChecker(trapField, robotDescription=robotDescription, robotType=2),
    [[10,15]], [[10,1]],
    description, 2)
    )
...
benchList.append(Benchmark(
    "Bottleneck",
    CollisionChecker(bottleNeckField, robotDescription=robotDescription, robotType=2),
    [[4,15]], [[18,1]],
    description, 2)
    )
...
benchList.append(Benchmark(
    "Fat bottleneck",
    CollisionChecker(fatBottleNeckField, robotDescription=robotDescription, robotType=2),
    [[4,21]], [[18,1]],
    description, 2)
    )
...
benchList.append(Benchmark(
    "MyField",
    CollisionChecker(myField, robotDescription=robotDescription, robotType=2),
    [[4,21]], [[18,1]],
    description, 2))
